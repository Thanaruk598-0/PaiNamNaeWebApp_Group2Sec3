...
TC14 Passenger View And Download Tax Invoice
    ...
    Return To Main Page
    Reopen Documents
    Capture Page Screenshot    03_reopen_popup.png

    Download Tax Invoice


    Verify Download Success
    Capture Page Screenshot    04_final.png
...
View Tax Invoice First
    Click Element    xpath=(//button[@title="ดูเอกสาร"])[2]
...
Download Tax Invoice
    Click Element    xpath=(//button[@title="ดาวน์โหลด"])[2]


Verify Download Success
    Sleep    2s
    Element Should Be Visible    xpath=(//button[@title="ดาวน์โหลด"])[2]
    Page Should Contain    ใบกำกับภาษีแบบย่อ