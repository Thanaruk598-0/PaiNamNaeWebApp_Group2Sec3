...
Update Report Status To InProgress
    ...
    Open Report Detail
    Update Status    IN_PROGRESS    ทางเรากำลังดำเนินการตรวจสอบข้อมูล    กำลังดำเนินการ
...
Update Status
    [Arguments]    ${status_value}    ${note}    ${expected_label}
    ...
    Should Contain    ${selected_label}    ${expected_label}
